...
const exploreLinks = [
  ...
  { label: 'Events & Updates', id: 'events' },
    ...
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div className="footer-brand-col">
          ...
          <div className="footer-socials">
            ...
            <a className="social-link" href="mailto:Medicarenewzealand@gmail.com" aria-label="Email Medicare New Zealand">
        ...
        {/* Links Column - 2 Separate Columns */}
        <div className="footer-links-col explore-col">
          <h4 className="footer-col-title">Explore</h4>
          <ul className="footer-links-list explore-two-columns">
            {exploreLinks.map((link) => (
              <li key={link.label}>
                <a className="footer-link" href={`#${link.id}`} onClick={(e) => handleLinkClick(e, link.id)}>
      ...
      <div className="footer-copyright">
        ...
        <p className="developer-text">
          Developed by{' '}
          <a
            href="https://www.suhadigitech.com/"
            target="_blank"
